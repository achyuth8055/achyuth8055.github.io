"""
Simplified Flask-based Web UI for PDF to DOCX Conversion Testing
Imports are delayed to avoid OpenCV initialization issues
"""
...
def index():
    ...
    sample_dir = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'test', 'samples')
    sample_files = []
